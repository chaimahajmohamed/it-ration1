...
use Admin\FormationBundle\Entity\Evenement;
...
class EvenementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $evenements = $em->getRepository('AdminFormationBundle:Evenement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Admin\FormationBundle\Form\EvenementType', $evenement);
    ...
    {
        $deleteForm = $this->createDeleteForm($evenement);
        $editForm = $this->createForm('Admin\FormationBundle\Form\EvenementType', $evenement);
